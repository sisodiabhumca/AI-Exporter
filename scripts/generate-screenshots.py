...
def shot_popup():
    img, draw = base_canvas("Extension Popup", "Six platforms — formats, RAG chunking, and scheduled exports")
    ...
    rounded_rect(draw, (panel[0] + 200, panel[1] + 16, panel[0] + 280, panel[1] + 38), (255, 255, 255, 40))
    draw.text((panel[0] + 212, panel[1] + 20), "ChatGPT", fill=WHITE, font=font(11, True))
    draw.text((panel[0] + 20, panel[1] + 44), "Export from 6 AI platforms", fill=(220, 245, 238), font=font(11))
    ...
    y += 20
    for label in ["Universal JSON", "RAG JSONL", "Claude Project", "Gemini Import"]:
    ...
    draw.text((720, 170), "Supported platforms", fill=TEXT, font=font(20, True))
    platforms = [
        ("ChatGPT", "chatgpt.com"),
        ("Claude", "claude.ai"),
...
def shot_floating_button():
    ...
    draw.text((120, 190), "claude.ai", fill=MUTED, font=font(14))
    ...
    draw.text((940, 200), "Works on 6 platforms", fill=TEXT, font=font(22, True))
    draw.text((940, 250), "ChatGPT · Claude · Gemini", fill=MUTED, font=font(16))
    draw.text((940, 280), "Copilot · DeepSeek · Grok", fill=MUTED, font=font(16))
    draw.text((940, 330), "One click → ZIP download", fill=MUTED, font=font(18))
...
def shot_progress():
    ...
    draw.text((430, 375), "Downloading 12 of 48 · DeepSeek", fill=MUTED, font=font(18))
...
def shot_panel():
    ...
    y = 260
    for label in ["Markdown", "RAG JSONL", "Notion", "Obsidian", "Claude"]:
...
def shot_promo_small():
    ...
    draw = ImageDraw.Draw(img)
    draw.text((40, 50), "AI Exporter", fill=WHITE, font=font(48, True))
    draw.text((40, 120), "6 AI platforms → portable exports", fill=(220, 245, 238), font=font(22))
    draw.text((40, 160), "ChatGPT · Claude · Gemini · Copilot", fill=(220, 245, 238), font=font(17))
    draw.text((40, 190), "DeepSeek · Grok", fill=(220, 245, 238), font=font(17))
