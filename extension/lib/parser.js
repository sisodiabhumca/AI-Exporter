...
AIExporter.parser = {
  ...
  toConversationSummary(convo, options = {}) {
    ...
    return {
      ...
      project_name: convo.project_name || null,
      gizmo_id: convo.gizmo_id || null,
      list_source: convo.list_source || null,
      project_instructions: convo.project_instructions || null,
